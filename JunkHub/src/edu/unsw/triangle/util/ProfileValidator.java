...
public class ProfileValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) throws ValidationException 
	{
		...
		ValidationUtility.rejectInvalidCharacters(errors, "username", profile.getUsername(), "username cannot contain spaces");
		...
		ValidationUtility.rejectInvalidCharacters(errors, "password", profile.getPassword(), "password cannot contain spaces");
