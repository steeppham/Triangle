...
import edu.unsw.triangle.command.ConfirmPageRequest;
import edu.unsw.triangle.command.LoginAction;
import edu.unsw.triangle.command.LoginPageRequest;
import edu.unsw.triangle.command.MainPageRequest;
import edu.unsw.triangle.command.ProfileAction;
import edu.unsw.triangle.command.ProfilePageRequest;
import edu.unsw.triangle.command.RegisterAction;
import edu.unsw.triangle.command.RegisterPageRequest;
import edu.unsw.triangle.command.SearchAction;
